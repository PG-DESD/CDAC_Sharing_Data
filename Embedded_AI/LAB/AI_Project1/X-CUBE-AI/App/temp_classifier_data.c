...
ai_buffer g_temp_classifier_data_map_activations[AI_TEMP_CLASSIFIER_DATA_ACTIVATIONS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 96, 1, 1),
    96, NULL, NULL),    /* heap_overlay_pool */
  };
ai_buffer g_temp_classifier_data_map_weights[AI_TEMP_CLASSIFIER_DATA_WEIGHTS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 780, 1, 1),
    780, NULL, s_temp_classifier_weights_array_u64),   /* weights_array */
  };
...
ai_buffer ai_temp_classifier_data_activations_buffer_get(const ai_handle ptr)
{
  ai_buffer buf = AI_BUFFER_INIT(
    ...
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, AI_TEMP_CLASSIFIER_DATA_ACTIVATIONS_SIZE, 1, AI_TEMP_CLASSIFIER_DATA_ACTIVATIONS_COUNT),
    AI_TEMP_CLASSIFIER_DATA_ACTIVATIONS_SIZE,
    NULL, ptr);
  return buf;
}
...
ai_buffer ai_temp_classifier_data_weights_buffer_get(const ai_handle ptr)
{
  ai_buffer buf = AI_BUFFER_INIT(
    ...
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, AI_TEMP_CLASSIFIER_DATA_WEIGHTS_SIZE, 1, AI_TEMP_CLASSIFIER_DATA_WEIGHTS_COUNT),
    AI_TEMP_CLASSIFIER_DATA_WEIGHTS_SIZE,
    NULL, ptr);
  return buf;
}
...
{
  return AI_HANDLE_PTR(g_temp_classifier_weights_table);
