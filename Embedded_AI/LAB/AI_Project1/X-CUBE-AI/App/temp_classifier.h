/**
  ...
  ******************************************************************************
  */
#ifndef AI_TEMP_CLASSIFIER_H
#define AI_TEMP_CLASSIFIER_H

#include "temp_classifier_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_TEMP_CLASSIFIER_MODEL_NAME          "temp_classifier"
#define AI_TEMP_CLASSIFIER_ORIGIN_MODEL_NAME   "dht22_temp_classifier"

/******************************************************************************/
#define AI_TEMP_CLASSIFIER_ACTIVATIONS_ALIGNMENT   (4)
#define AI_TEMP_CLASSIFIER_INPUTS_IN_ACTIVATIONS   (4)
#define AI_TEMP_CLASSIFIER_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_TEMP_CLASSIFIER_IN_NUM        (1)

AI_DEPRECATED
#define AI_TEMP_CLASSIFIER_IN \
  ai_temp_classifier_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_TEMP_CLASSIFIER_IN_SIZE { \
  AI_TEMP_CLASSIFIER_IN_1_SIZE, \
}
#define AI_TEMP_CLASSIFIER_IN_SIZE_BYTES { \
  AI_TEMP_CLASSIFIER_IN_1_SIZE_BYTES, \
}
#define AI_TEMP_CLASSIFIER_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_TEMP_CLASSIFIER_IN_1_CHANNEL     (1)
#define AI_TEMP_CLASSIFIER_IN_1_SIZE        (1)
#define AI_TEMP_CLASSIFIER_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_TEMP_CLASSIFIER_OUT_NUM       (1)

AI_DEPRECATED
#define AI_TEMP_CLASSIFIER_OUT \
  ai_temp_classifier_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_TEMP_CLASSIFIER_OUT_SIZE { \
  AI_TEMP_CLASSIFIER_OUT_1_SIZE, \
}
#define AI_TEMP_CLASSIFIER_OUT_SIZE_BYTES { \
  AI_TEMP_CLASSIFIER_OUT_1_SIZE_BYTES, \
}
#define AI_TEMP_CLASSIFIER_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_TEMP_CLASSIFIER_OUT_1_CHANNEL     (3)
#define AI_TEMP_CLASSIFIER_OUT_1_SIZE        (3)
#define AI_TEMP_CLASSIFIER_OUT_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_TEMP_CLASSIFIER_N_NODES (6)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup temp_classifier
 ...
 * @ref ai_temp_classifier_create. Both the activations memory buffer 
 ...
 * using @ref ai_temp_classifier_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_temp_classifier_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_temp_classifier_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_TEMP_CLASSIFIER_*
 * defines into file @ref temp_classifier.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_temp_classifier_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_TEMP_CLASSIFIER_H */
